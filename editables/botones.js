...
"<tr><th><div class=' text-center line-normal4ta'><p class='text-font500 text-xx'><span class=' text-azulOsc'>Usa tu tarjeta por lo menos una vez al mes.</span></p></div></th>"+
"<th><div class=' text-center line-normal4ta'><p class='text-fontM text-4taSection'><span class=' text-azulOsc'>Cuota de Manejo Gratis</span><br><span class='text-col-negro text-font500 text-xx'>por 3 meses (enero, febrero y marzo)</p></div></th></tr>"+
...
function EleccionTarjeta(Elect) {
    ...
    if(Elect=='Si'){
        ...
        document.getElementById('btnSi').style.backgroundColor='#feda00'
        document.getElementById('btnNo').style.backgroundColor='#fff'
    }else if(Elect=='No'){
        ...
        document.getElementById('btnSi').style.backgroundColor='#fff'
        document.getElementById('btnNo').style.backgroundColor='#feda00'
    }
